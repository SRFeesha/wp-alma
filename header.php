...
<div id="page" class="site">
	...
	<header id="masthead" class="site-header">
		<div class="site-branding">
			...
			$alma_wp_description = get_bloginfo( 'description', 'display' );
			if ( $alma_wp_description || is_customize_preview() ) :
				?>
				<p class="site-description"><?php echo $alma_wp_description; /* WPCS: xss ok. */ ?></p>
			<?php endif; ?>
		</div><!-- .site-branding -->
